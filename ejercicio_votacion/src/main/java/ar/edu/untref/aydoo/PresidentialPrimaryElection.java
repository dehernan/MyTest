...
public class PresidentialPrimaryElection {
    ...
    List politicalParties = new ArrayList<PoliticalParty>();
    List candidates = new ArrayList<Candidate>();
    ...
    public PoliticalParty getPoliticalParty(String name){
        ...
        while(iterator.hasNext()){
            ...
            if(iterator.next().getName() == name){
                ...
                return (PoliticalParty) politicalParties.get(contador-1);
    ...
    public int votesByParty(PoliticalParty party) {
        ...
        while (iterador.hasNext()) {
            ...
            if (iterador.next().getPoliticalParty() == party) {
    ...
    public String nationallyMostVotedCandidate(List<Candidate> candidates){
    ...
    public String provinciallyMostVotedCandidate(Province province, List<Candidate> candidates){
    ...
    public String nationallyMostVotedParty(List<Candidate> candidates){
    ...
    public String provinciallyMostVotedParty(Province province, List<Candidate> candidates){
